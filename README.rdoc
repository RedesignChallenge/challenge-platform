...
Challenge Platform is an open source application that leads participants through a multi-stage problem solving process and allows them to collaborate and develop real-world solutions to specific challenges.
